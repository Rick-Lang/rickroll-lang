...
class Token:
    ...
    # Operators
        ...
        # Relational Operator
        elif self.tokens[i] in OP_relational or self.tokens[i] in OP_type_conversion:
            if self.tokens[i] == 'is':
                add_operator('==')
...
class Main:
    ...
    def run(self):
        ...
        try:
            ...
            print('<' + "There ain't no maistaking, is true love we are making~" + '>')
